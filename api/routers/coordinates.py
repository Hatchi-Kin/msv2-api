...
async def get_coordinate_points(
    ...
    return await get_all_points_handler(coords_repo, params.limit, params.offset)
...
async def get_coordinate_stats(
    ...
    return await get_statistics_handler(coords_repo)
...
async def search_coordinate_tracks(
    ...
    return await search_tracks_handler(coords_repo, params.q, params.limit)
...
async def get_cluster_details(
    ...
    return await get_cluster_handler(coords_repo, cluster_id)
...
async def get_track_neighbors(
    ...
    return await get_track_neighbors_handler(coords_repo, track_id, params.limit)
